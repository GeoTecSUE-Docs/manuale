---
title: Errori Permesso di Costruire - Regione Piemonte
...
{: .note }
> Questa guida copre tutti i controlli di validazione del Permesso di Costruire. Per errori comuni a tutte le pratiche, vedi [Errori Comuni](errori-validazione.html#errori-comuni).
...
12. [Allacciamenti fognatura](#12-allacciamenti-fognatura)
13. [Data e luogo](#13-data-e-luogo)
14. [Tecnici nei soggetti coinvolti](#14-tecnici-nei-soggetti-coinvolti)
15. [Imprese nei soggetti coinvolti](#15-imprese-nei-soggetti-coinvolti)
...
3. Consulta [Compilare istanza PdC](compilare-istanza.html)
...
**Fonte**: Analisi codice ValidaDatiPdC e DatiPdC.ascx
