---
title: Errori CILA - Regione Lombardia
parent: Errori di validazione
nav_order: 17
description: Errori di validazione specifici per la CILA (Comunicazione di Inizio Lavori Asseverata) Regione Lombardia - Guida dettagliata campo per campo
keywords: [CILA Lombardia, comunicazione inizio lavori asseverata, errori CILA Lombardia, validazione CILA, coordinate UTM, regolarità urbanistica, Ge.CA, art 6-bis DPR 380]
IDRegione: 4
IDTipoPratica: 425
Fonte: Manuale
---
...
11. [Consapevolezza efficacia procedura](#11-consapevolezza-efficacia-procedura)
12. [Normativa sulla privacy](#12-normativa-sulla-privacy)
13. [Tecnici nei soggetti coinvolti](#13-tecnici-nei-soggetti-coinvolti)
14. [Imprese nei soggetti coinvolti](#14-imprese-nei-soggetti-coinvolti)
...
- ⚪ **e.1** — **i lavori avranno inizio** → specifica poi la modalità di inizio (data o dopo atti di assenso)
- ⚪ **e.2** — **l'intervento in corso di esecuzione**, iniziato in data ___ (art. 6-bis c. 5 — con sanzione di € 333,00)
- ⚪ **e.3** — **l'intervento realizzato** in data ___ (art. 6-bis c. 5 — con sanzione di € 1.000,00)
- ⚪ **e.4** — **intervento in modifica dei lavori** di cui alla CILA comunicata → inserisci data e n. protocollo
...
**Fonte**: Analisi codice ValidaDatiCILALombardia e DatiCILALombardia.ascx
