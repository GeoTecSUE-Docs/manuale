---
title: Errori SCIA - Regione Piemonte
...
{: .note }
> Questa guida copre tutti i controlli di validazione della SCIA. Per errori comuni a tutte le pratiche, vedi [Errori Comuni](errori-validazione.html#errori-comuni).
...
12. [Cadute dall'alto](#12-cadute-dallalto)
13. [Data e luogo](#13-data-e-luogo)
...
2. Seleziona **una delle quattro opzioni**:
   ...
   - ⚪ **Opzione 4** — **Interventi non in copertura** o rientranti nei casi di esclusione (art. 3 c. 2 lett. a, c, d)
3. Clicca **"Salva"** e riprova **"Valida e Salva"**
...
- Destinazione d'uso (menu con CTRL+click per selezione multipla)
...
**Fonte**: Analisi codice ValidaDatiSCIA e DatiSCIA.ascx
