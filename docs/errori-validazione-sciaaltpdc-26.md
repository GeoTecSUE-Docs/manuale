---
title: Errori SCIA Alternativa al PdC - Regione Piemonte
...
{: .note }
> Questa guida copre tutti i controlli di validazione della SCIA alt. PdC. Si tratta di una pratica **distinta** dalla SCIA ordinaria (art. 22): copre interventi di maggior rilevanza urbanistica e richiede sezioni aggiuntive, in particolare la **Regolarità urbanistica e precedenti edilizi** e le **Misure per la prevenzione delle cadute dall'alto**. Per errori comuni a tutte le pratiche, vedi [Errori Comuni](errori-validazione.html#errori-comuni).
...
2. [Presentazione della SCIA](#2-presentazione-della-scia)
...
11. [Misure per la prevenzione delle cadute dall'alto](#11-misure-per-la-prevenzione-delle-cadute-dallalto)
12. [Data e luogo](#12-data-e-luogo)
...
2. Seleziona **"SÌ"** o **"NO"**:
   ...
   **SÌ** (intervento APPLICA il Regolamento D.P.G.R. 6/R/2016) → spunta **almeno una** delle tre opzioni:
...
**Fonte**: Analisi codice ValidaDatiSCIAaltPDC e DatiSCIAaltPDC.ascx
